...
class SuperHitDeals extends StatefulWidget {
  @override
  _SuperHitDealsState createState() => _SuperHitDealsState();
}

class _SuperHitDealsState extends State<SuperHitDeals> {
  MediaQueryData data;
